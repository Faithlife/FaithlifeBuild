...
| static [PublishContainer](DotNetBuild/PublishContainer.md)(…) | Publishes a .NET project as a container image. |
| static [RunTests](DotNetBuild/RunTests.md)(…) | Runs tests on the specified paths. (2 methods) |
