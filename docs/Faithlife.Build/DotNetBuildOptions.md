...
| [BranchOption](DotNetBuildOptions/BranchOption.md) { get; set; } | The git branch being built. |
| [ConfigurationOption](DotNetBuildOptions/ConfigurationOption.md) { get; set; } | The configuration to build. |
| [NuGetApiKeyOption](DotNetBuildOptions/NuGetApiKeyOption.md) { get; set; } | NuGet API key for publishing. |
